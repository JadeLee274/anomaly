# Metrics
This repository is on the suggested (alternative) metrics for anomaly detection performance.
...
So, more reliable metric is needed for future research.

## Towards a Rigorous Evaluation of Time-series Anoamly Detection [AAAI 2022]

## Volume Under the Surface: A New Accuracy Evlauation Measure for Time-Series Anomaly Detection [VLDB 2022]
