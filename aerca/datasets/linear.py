...
class Linear:
    def __init__(self, options: Dict[str, Any]) -> None:
        """
        Initializes the LinarDynamics class to generate synthetic datasets with linear dynamics.
    ...
    def _generate_random_coefficients(self) -> Vector:
        """
    ...
    def generate_example(self) -> None:
        ...
        for i in range(self.n):
            # Generage random noise for each variable
    ...
    def load_dict(self) -> None:
        ...
        self.data_dict['causal_struct_value'] = np.load(os.path.join(self.data_dir, 'causal_struct.npy'))
